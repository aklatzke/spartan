...
class Song extends TypeBuilder
{
    ...
    public function init(){
        ...
        $options = array(
            ...
            'has_archive' => 'all/songs'
        );
        # these are the "labels" option when declaring a custom post type,
        # broken out here so that it's not a mess
        $labels = array(
            'name' => __('Song', 'bonestheme'),
            'singular_name' => __('Song', 'bonestheme'),
            'all_items' => __('Manage Song ', 'bonestheme'),
            'add_new' => __('Add New', 'bonestheme'),
            'add_new_item' => __('Add New Song', 'bonestheme'),
            'edit' => __('Edit', 'bonestheme'),
            'edit_item' => __('Edit Song', 'bonestheme'),
            'new_item' => __('New Song', 'bonestheme'),
            'view_item' => __('View Song', 'bonestheme'),
            'search_items' => __('Search Song', 'bonestheme'),
            'not_found' => __("No Song found.", 'bonestheme'),
    ...
    public function initializeFields()
    {
        ...
        $this->createFieldGroup(array(
            ...
            "fields" => array( "title", "artist", "album", 'review', 'color', 'textColor', 'releaseDate', 'itunesTrackId', 'itunesCollectionId'),
            "labels" => array( "Title", "Artist", 'Album', "Review", 'Color', 'Text Color', "Release Date", 'itunesTrackId', 'itunesCollectionId'),
